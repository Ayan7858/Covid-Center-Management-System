...
class Fee():
    ...
    def __init__(self, master):
        ...
        Title_Frame = LabelFrame(master, width=1350, height=100, bg='#545454', relief='ridge', bd=15)
        Title_Frame.pack(side=TOP)

        lblTitle = Label(Title_Frame, font=('arial', 40, 'bold'), fg='white', text='PATIENT DETAILS', bg='#545454',
                         padx=13)
        lblTitle.grid(padx=400)

        Data_Frame = Frame(master, width=1350, height=350, bg='#666666', relief='ridge', bd=1)
        Data_Frame.pack(side=TOP, padx=10, pady=5)

        Frame_1 = LabelFrame(Data_Frame, width=850, height=350, bg='#666666', relief='ridge', bd=8, text='Informations',
                             fg='white', font=('arial', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=10, pady=5)

        List_Frame = Frame(master, width=1350, height=350, bg='#666666', relief='ridge', bd=15)
        List_Frame.pack(side=TOP, padx=15, pady=7)

        # ===================================================Labels================================================

        self.cid_label = Label(Frame_1, text='Name: ', font=(
            'arial', 14, 'bold'), bg='#666666', fg='white')
        ...
        self.centre_label = Label(Frame_1, text='CID: ', font=(
            'arial', 14, 'bold'), bg='#666666', fg='white')
        ...
        self.result_entry = ttk.Combobox(Frame_1, values=('Positive', 'Negative'), font=('arial', 14), width=14,
        ...
        btnSearch = Button(Frame_1, text='SEARCH', font=(
            'arial', 14, 'bold'), width=10)
        ...
        btnExit.grid(row=1, column=5, padx=5, pady=5)

        s_rep_btn= Button(Frame_1, text='Send Report', font=(
            'arial', 14, 'bold'), width=10, command=lambda: self.send_report(root))
        s_rep_btn.grid(row=1, column=4, padx=5, pady=5)
        ...
        self.patient_rec.heading("cid", text="CID")
    ...
    def delete(self):
        conn = mysql.connector.connect(host="localhost", user="root", password="hello", database="mini",
                                       auth_plugin='mysql_native_password')
        my_cursor = conn.cursor()
        my_cursor.execute("delete from book_table where cid=%s",self.cid_entry.get())
    ...
    # return rec_email
        ...
        msg.set_content('Thank You for contacting Care19.')
